...
function DescriptionSection() {
    return (
        <div className='descrption-section m flex justify-center flex-col'>
            ...
            <div className="sec-2-main flex">
                ...
                <div className="sec-sub-1">
                    <h1 className='descrip-2 text-3xl p-[4vw] mx-[1vw] lg:px-[5vw] lg:mx-[2vw] '>Welcome to our interactive planets directory! Dive into the fascinating world of Star Wars and discover
                ...
                <div className="sec-sub-2">
                    <img className='sateliteship lg:w-[100vw]' src="../../../images/sateliteship.png" alt="" />
                </div>
